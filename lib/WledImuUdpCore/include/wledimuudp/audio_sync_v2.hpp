...
inline constexpr std::array<std::uint8_t, 6> kAudioSyncV2Header{
    0x30, 0x30, 0x30, 0x30, 0x32, 0x00};
...
struct DecodeResult {
  ...
  [[nodiscard]] constexpr bool ok() const noexcept { return error == DecodeError::kNone; }
};
