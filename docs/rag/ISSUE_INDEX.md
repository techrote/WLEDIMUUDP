...
| Roadmap ID | GitHub issue | Purpose | Depends on | State at WU-006 implementation |
|---|---:|---|---|---|
...
| WU-006 | #6 | End-to-end stock-WLED integration, diagnostics and tuning | #1–#5 | implementation PR #13 |
| WU-007 | #7 | Release hardening, setup UX and reproducible packaging | #1–#6 | blocked until #6 acceptance |
